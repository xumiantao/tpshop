...
function getAllMenu(){
	return	array(
			...
			'promotion' => array('name' => '房间管理', 'icon'=>'fa-bell', 'sub_menu' => array(
				...
				//	array('name' => '代金券管理','act'=>'index', 'control'=>'Coupon'),
			        array('name' => '房间列表','act'=>'roomList', 'control'=>'Promotion'),
			)),
			'Ad' => array('name' => '公告管理', 'icon'=>'fa-flag', 'sub_menu' => array(
					array('name' => '公告编辑', 'act'=>'adList', 'control'=>'Ad'),
			)),
...
*/
			...
			// )),
			'count' => array('name' => '设置', 'icon'=>'fa-signal', 'sub_menu' => array(
					array('name' => '轮播图', 'act'=>'index', 'control'=>'Report'),
			...
			'pickup' => array('name' => '物流管理', 'icon'=>'fa-anchor', 'sub_menu' => array(
					array('name' => '物流公司', 'act'=>'index', 'control'=>'Pickup'),
					array('name' => '添加物流公司', 'act'=>'add', 'control'=>'Pickup'),
			))
	);
}
