                ...
                <div class="col-sm-12">
                    <div class="box">
                        ...
                        <div class="box-body">                         
                             ...
                             <form action="<?php echo U('Home/Index/uploadimg');?>" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                                        <label class="control-label col-sm-2">图片</label>

                                    <div class="col-sm-10">
                                        <input name='img' type="file"   style="width:500px;display:initial;"/>
                                    </div>
                                </div>                                
