		...
		<div class="mui-content" style="margin-top: 20px;">
			...
			<div class="mui-add-new">
					...
					<div class="mui-input-row">
						<label>请输入用户名</label>
						<input name='username' type="text" class="mui-input-clear" placeholder="ffloo">
					</div>
			...
			<div class="mui-add-new">
					...
					<div class="mui-input-row">
						<label>再次输入密码</label>
						<input name='pwd2' type="password" class="mui-input-password" placeholder="******">
					</div>
				
			</div>

			<div class="mui-input-row mui-radio mui-left mui-input-address" style="margin-left: 0;">
				<div class="mui-input-row mui-checkbox mui-left">
					<label style="padding-left: 40px;">同意《用户协议》</label>
					<input checked="checked" name="checkbox" value="Item 1" type="checkbox" id="login">
				</div>
			</div>
			<div class="mui-buttom-data mui-button-deta" style="">
				<button type="button" class="mui-btn mui-btn-danger mui-data-btn aa">注册</button>
			</div>
			</form>
		</div>
		</div>
		...
		<script >
			$('.aa').click(function(){
				...
				if(s!=true){
					...
					$.ajax({
						type:'post',
						url:"<?php echo U('Home/User/register');?>",
						data:data,
						dataType:'json',
